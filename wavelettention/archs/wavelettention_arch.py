...
class Wavelettention(nn.Module):
    r""" Hybrid Attention Transformer architecture encapsulated by NLSA blocks and trained with additional wavelet loss function

        A PyTorch implementation of : `Training Transformer Models by Wavelet Losses Improves Quantitative and Visual Performance in Single Image Super-Resolution`.
    ...
    def __init__(self,
                 ...
                 resi_connection='1conv',
                 **kwargs):
        super(Wavelettention, self).__init__()
...
if __name__ == '__main__':
    ...
    height = 64
    width = 64
    model = Wavelettention(img_size=(height, width),
                 patch_size=1,
                 in_chans=3,
                 embed_dim=180,
                 depths=(6, 6, 6, 6),
